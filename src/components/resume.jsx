    ...
    <div className={styles.container}>
      <div className={styles.section}>
        <div className={styles.job}>
          ...
          <span className={styles.jobdesc}>
            Lead initiative for product expansion into baby registries by owning
            requirements and managing product scope across 8 engineering teams.{" "}
          </span>
        </div>
      ...
      <div className={styles.section}>
        <div className={styles.job}>
          ...
          <span className={styles.jobdesc}>
            Product management for GoodRx Telehealth Growth team / HeyDoctor.com{" "}
          </span>
        </div>
        <div className={styles.dates}>
